        ...
        <Routes>
          ...
          <Route element={ <ProtectedRoute allowedRoles={['HEAD_CHEF', 'SOUS_CHEF']} /> } >
            <Route path='admin' element={<AdminLayout />}>
              ...
              <Route path="dish-suggestions/:id" element={<AdminSuggestionDetailPage />} />
              ...
              <Route path='ingredient-requests' element={<IngredientRequestManagementPage />} />
              <Route path='ingredient-requests/:id' element={<AdminIngredientRequestDetailPage />} />
              <Route path='shopping-lists'element={<ShoppingListManagementPage />} />
              <Route path='shopping-lists/:id' element={<ShoppingListDetailPage />} />
              <Route path='takeaway' element={<TakeawayManagementPage />} />
              <Route path='takeaway/:id' element={<AdminTakeawayOfferDetailPage />} />
              <Route path='takeaway-orders' element={<UnderDevelopmentPage />} />
              <Route path="profile" element={<UserProfilePage />} />
            </Route>
          </Route>

          <Route element={ <ProtectedRoute allowedRoles={['HEAD_CHEF', 'SOUS_CHEF', 'LINE_COOK']} /> } >
            <Route path="kitchen" element={<KitchenLayout />}>
              <Route index element={<Navigate to="menu" replace />} />
              <Route path="menu" element={<PublicMenuPage />} />
              <Route path="suggestions" element={<KitchenSuggestionsPage />} />
              <Route path="suggestions/:id" element={<KitchenSuggestionDetailPage />} />
              <Route path="inspiration" element={<InspirationPage />} />
              <Route path="requests" element={<KitchenIngredientRequestPage />} />
              <Route path="requests/:id" element={<KitchenIngredientRequestDetailPage />} />
              <Route path="profile" element={<UserProfilePage />} />
            </Route>
          </Route>
