...
const RegisterPage = () => {
  ...
  const handleRegister = async (formData) => {
    ...
    setFormSuccess( `Velkommen ${createdUser.firstName} ${createdUser.lastName}. Du viderestilles til login...`);
  ...
  return (
    <>
      ...
      <p className={styles.subtitle}>Få adgang til dit digitale projektstyrings værktøj</p>
